...
[Heracles no Eikou: Ugokidashita Kamigami - The Snap-Story (Alternative English Translation)](#heracles-no-eikou-ugokidashita-kamigami---the-snap-story-alternative-english-translation) | GB
...
[Snowboard Champion (English Translation v1.01)](#snowboard-champion-english-translation-v1-01) | GBC
...
This patch converts `After Burst (J)` to the `.pocket` format.
...
## Arcade Classic No. 4 - Defender and Joust

This patch converts `Arcade Classic No. 4 - Defender and Joust (U,E)` to the `.pocket` format.
...
This patch converts `Arcade Hits - Moon Patrol and Spy Hunter (U)` to the `.pocket` format.
...
This patch converts `Aretha (J)` to the `.pocket` format.
...
This patch converts `Aretha III (J)` to the `.pocket` format.
...
This patch converts `Army Men (U,E)` to the `.pocket` format.
...
This patch converts `Astro Rabby (J)` to the `.pocket` format.
...
This patch converts `Ayakashi no Shiro (J)` to the `.pocket` format.
...
This patch converts `Battle City (J)` to the `.pocket` format.
...
This patch converts `Battleship (U,E)` to the `.pocket` format.
...
This patch converts `B-Daman Bakugaiden - Victory e no Michi (J)` to the `.pocket` format.

ROM MD5: `ba1195224261abd308db025d69ee2227`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/BDamanBakugaidenVictoryENoMichi.ips).
...
## Bokujou Monogatari GB 2

This patch converts `Bokujou Monogatari GB 2 (J)` to the `.pocket` format.

ROM MD5: `245c759effda3cf83e2caf274c93c8aa`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/BokujouMonogatariGB2.ips).

## Bomberman GB

This patch converts `Bomberman GB (U,E)` to the `.pocket` format.
...
This patch converts `Bomberman Max - Red Challenger (U)` to the `.pocket` format.

ROM MD5: `1757723cf346be2cea58d0fc4ed4cfa9`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/BombermanMaxRed.ips).
...
This patch converts `Bomberman Quest (E)` to the `.pocket` format.

ROM MD5: `e6f36322946499f2f55b724c3db916cd`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/BombermanQuestE.ips).
...
This patch converts `Bomb Jack (E)` to the `.pocket` format.
...
This patch converts `Boomer's Adventure in ASMIK World (U)` to the `.pocket` format.
...
This patch converts `Bubble Bobble Part 2 (U,E)` to the `.pocket` format.

ROM MD5: `8bbb9ba0d72548706e4e5eba1b3a9fe1`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/BubbleBobblePart2.ips).

## Bubble Ghost

This patch converts `Bubble Ghost (U,E)` to the `.pocket` format.
...
This patch converts `Bust-A-Move 3 DX (E)` to the `.pocket` format.
...
This patch converts `Casper (U)` to the `.pocket` format.

ROM MD5: `792c706a0addebed39d177077a1caac0`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/Casper.ips).
...
This patch converts `Chase H.Q. - Secret Police (U)` to the `.pocket` format.
...
This patch converts `Classic Bubble Bobble (E)` to the `.pocket` format.
...
This patch converts `Color Test (U,E)` to the `.pocket` format.

ROM MD5: `a973913be575962df815307b25875f1e`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/ColorTest.ips).
...
This patch converts `Cool Bricks (E)` to the `.pocket` format.
...
This patch converts `Croc 2 (U,E)` to the `.pocket` format.

ROM MD5: `03a8bcab4b2975fa2d850d18c728ea9c`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/Croc2.ips).

## Crusin' Exotica

This patch converts `Crusin' Exotica (U)` to the `.pocket` format.

ROM MD5: `3af0cf37eadd6e98fdc43d4b3967c966`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/CruisnExotica.ips).
...
This patch converts `Dance Dance Revolution GB2 (J)` to the `.pocket` format.

ROM MD5: `7f306f573ca9759fa2f7aa167ca2dd74`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/DDR2.ips).

## Dance Dance Revolution GB3

This patch converts `Dance Dance Revolution GB3 (J)` to the `.pocket` format.

ROM MD5: `3ced79ad60ab5195058d5d658550f04f`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/DDR3.ips).

## Dance Dance Revolution GB - Disney Mix

This patch converts `Dance Dance Revolution GB - Disney Mix (J)` to the `.pocket` format.
...
This patch converts `Darkman (U,E)` to the `.pocket` format.

ROM MD5: `849c5fe4002dd4240020e9ec84c8dc29`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/Darkman.ips).
...
This patch converts `Darkwing Duck (DE)` to the `.pocket` format.

ROM MD5: `b364d2bbe0a3a09adafa9b6b982a9acb`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/DarkwingDuckDE.ips).
...
This patch converts `Darkwing Duck (ES)` to the `.pocket` format.

ROM MD5: `780bbec4b26617b3a1a4fcdfa5a731e4`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/DarkwingDuckES.ips).
...
This patch converts `Die Maus GBC (E)` to the `.pocket` format.

ROM MD5: `f9be99d213760ba2e9525abea1de3cb6`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/DieMausGBC.ips).
...
## Donkey Kong Land 2 - Game Boy Color Edition (v1.1)

This patch converts `Donkey Kong Land 2 - Game Boy Color Edition (v1.1)` to the `.pocket` format. First, apply the [colorization patch](https://www.romhacking.net/hacks/6866/), then apply this patch. The MD5 below is for the patched ROM.

ROM MD5: `736a016646e66873946fff5c468a1358`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/DKL2Color.ips).

## Donkey Kong Land 2 - Game Boy Color Edition (v1.2)

This patch converts `Donkey Kong Land 2 - Game Boy Color Edition (v1.2)` to the `.pocket` format. First, apply the [colorization patch](https://www.romhacking.net/hacks/6866/), then apply this patch. The MD5 below is for the patched ROM.

ROM MD5: `57684dda234b7076fe9b6fc8cd831d79`
...
This patch converts `Dr. Mario (World)` to the `.pocket` format.

ROM MD5: `0281fd8061d82472e242954513805196`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/DrMario.ips).
...
This patch converts `Droneboy` to the `.pocket` format. You can get a copy of the ROM from the [developer's site](https://github.com/purefunktion/Droneboy).

ROM MD5: `f229536982f8ba9c42172800e542f1e2`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/Droneboy.ips).

## Dropzone

This patch converts `Dropzone (E)` to the `.pocket` format.
...
This patch converts `Elevator Action EX (E)` to the `.pocket` format.
...
This patch converts `Extra Bases! (U)` to the `.pocket` format.

ROM MD5: `857fdafb5ababd641cc832cfb8fabd58`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/ExtraBases.ips).
...
This patch converts `F-18 Thunder Strike (U,E)` to the `.pocket` format.

ROM MD5: `58670204ec7b8791576e3c88ba7c1ddf`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/F18Thunder.ips).
...
This patch converts `Flintstones (U,E)` to the `.pocket` format.
...
This patch converts `Frogger GBC (U,E)` to the `.pocket` format.

ROM MD5: `d94e22b4c08ab3c7b1929f5490adcbf2`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/FroggerGBC.ips).
...
This patch converts `Ganso!! Yancha Maru (J)` to the `.pocket` format.

ROM MD5: `a60df6aeb6820683805be1717097fca8`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/Ganso.ips).
...
This patch converts `Gauntlet II (U,E)` to the `.pocket` format.
...
This patch converts `Godzilla (U,E)` to the `.pocket` format.
...
This patch converts `Hammerin' Harry - Ghost Building Company (E)` to the `.pocket` format.
...
This patch converts `Harry Potter and the Chamber of Secrets (U, E)` to the `.pocket` format.
...
This patch converts `Harvest Moon GBC (U)` to the `.pocket` format.
...
## Heracles no Eikou: Ugokidashita Kamigami - The Snap-Story (Alternative English Translation)

This patch converts `Heracles no Eikou: Ugokidashita Kamigami - The Snap-Story (Alternative English Translation)` to the `.pocket` format. First, apply the [English Translation Patch](https://www.romhacking.net/translations/3365/), then apply this patch.

ROM MD5: `f14f37c5e251b88dce2ad1373e8a69e8`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/HeraclesEN_Alt.ips).
...
This patch converts `Hook (U)` to the `.pocket` format.

ROM MD5: `c4e2de3be0bb5608ab903a885afc065d`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/Hook.ips).
...
This patch converts `Hoyle Casino (U)` to the `.pocket` format.

ROM MD5: `e0245d992101be481c355e3e2c2cbb83`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/HoyleCasino.ips).
...
This patch converts `Hugo - Black Diamond Fever (E)` to the `.pocket` format.

ROM MD5: `0762fc989c52652b2660f26be0830f20`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/HugoBlackDiamondFever.ips).
...
This patch converts `Inspector Gadget - Operation Madkactus (U)` to the `.pocket` format.

ROM MD5: `f9594360b2a4ed8745b63304063baabb`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/InspectorGadget.ips).
...
This patch converts `Joe and Mac (U)` to the `.pocket` format.

ROM MD5: `a4627fb86c2b91fc0ace4f628aa607e4`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/JoeMac.ips).
...
This patch converts `Jurassic Park (U)` to the `.pocket` format.
...
This patch converts `Ken Griffey Jr. Presents Major League Baseball (U,E)` to the `.pocket` format.
...
## Kirby's Dream Land 2 DX (1.1)

This patch converts `Kirby's Dream Land 2 DX (1.1)` to the `.pocket` format.

First, apply the [Kirby's Dream Land 2 DX](https://www.romhacking.net/hacks/7724/) patch. The MD5 below is the MD5 for the patched, colorized game.

ROM MD5: `5a55a031c97b9430f53049bd5e46b8a4`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/KirbysDreamLand2DX_1.1.ips).
...
This patch converts [Klondike](https://www.oocities.org/hergtoler/files/Klondike/ReadMe.txt) to the `.pocket` format.
...
This patch converts `Konami GB Collection Volume 2 (E)` to the `.pocket` format.
...
This patch converts `Legend of the River King GB (DE)` to the `.pocket` format.

ROM MD5: `c74c40b7da1a54568f4d5ccd3eb56090`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/LegendRiverKingGB_DE.ips).
...
This patch converts `LEGO Island 2 - The Brickster's Revenge (U)` to the `.pocket` format.

ROM MD5: `1d0ea47375fca723c0f86a5178e545f3`
...
This patch converts `Little Mermaid II - Pinball Frenzy (U)` to the `.pocket` format.
...
This patch converts `Lock n' Chase ~ Lock 'n' Chase (W)` to the `.pocket` format.
...
This patch converts `Looney Tunes (U,E)` to the `.pocket` format.
...
This patch converts `Looney Tunes Collector - Martian Quest! (J)` to the `.pocket` format.
...
This patch converts `Looney Tunes - Twouble! (U)` to the `.pocket` format.

ROM MD5: `1d31fa1e431ec840e5f769fdd019405f`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/LooneyTunesTwouble.ips).
...
This patch converts `Lucky Luke - Desperado Train (E)` to the `.pocket` format.
...
This patch converts `Maui Mallard (U)` to the `.pocket` format.

ROM MD5: `6dfcaebffc8e2645bb2b1e5be69e1514`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/MauiMallard.ips).
...
This patch converts `Medarot - Kabuto Version (J)` with the [English Translation patch](https://github.com/Medabots/medarot1/releases/download/0.6.7%2BEN.txt.20/m1kabuto-2198-ac8ec9b062466dc4133b3e6ba0d35bae4982ab09.ips) to the `.pocket` format.
...
You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/MedarotKabuto-EN.ips).
...
ROM MD5: `e2ccd9a7b098f83cfe66f959f402a4a2`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/MedarotKabuto-EN-US.ips).
...
This patch converts `Medarot - Kuwagata Version (J)` with the [English Translation patch](https://github.com/Medabots/medarot1/releases/download/0.6.7%2BEN.txt.20/m1kuwagata-2198-ac8ec9b062466dc4133b3e6ba0d35bae4982ab09.ips) to the `.pocket` format.
...
You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/MedarotKuwagata-EN.ips).
...
This patch converts `Medarot 2 - Kabuto Version (J)` to the `.pocket` format.

ROM MD5: `c0fd19d90d3d876cc321074239c7334e`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/Medarot2Kabuto.ips).

## Medarot 2 - Kuwagata Version

This patch converts `Medarot 2 - Kuwagata Version (J)` to the `.pocket` format.
...
This patch converts `Medarot 4 - Kabuto Version (J)` to the `.pocket` format.

ROM MD5: `c5effc311c2248d6de58b487e729406b`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/Medarot4Kabuto.ips).

## Medarot 4 - Kuwagata Version

This patch converts `Medarot 4 - Kuwagata Version (J)` to the `.pocket` format.
...
This patch was updated to fix a HUD rendering issue (2022/3/31)
...
This patch converts `Microsoft Pinball Arcade (U)` to the `.pocket` format.

ROM MD5: `31f7a606b52e8d10fc010b4efe9fb514`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/MSPinball.ips).
...
This patch converts `Mighty Morphin Power Rangers (U,E)` to the `.pocket` format.

ROM MD5: `5b83db9958eefbd72a82c4893e79d9e1`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/MightyMorphinPowerRangers.ips).
...
This patch converts `Monster Race (J)` to the `.pocket` format.
...
This patch converts `Monster Rancher Explorer (U)` to the `.pocket` format.
...
This patch converts `Mortal Kombat II (U,E)` to the `.pocket` format.

ROM MD5: `ce2927987765182b9c69f26f758656e9`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/MortalKombat2.ips).

## Mortal Kombat 3

This patch converts `Mortal Kombat 3 (U)` to the `.pocket` format.

ROM MD5: `c19d61e31d6aebc12abf80d628a7bd09`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/MortalKombat3.ips).

## Mortal Kombat 4

This patch converts `Mortal Kombat 4 (U,E)` to the `.pocket` format.

ROM MD5: `168ae412b379786f7df07bd8231baf44`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/MK4.ips).
...
This patch converts `Mr. Chin's Gourmet Paradise (U)` to the `.pocket` format.

ROM MD5: `1efbb42c4db24e5e42e778d969ba1f5d`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/MrChins.ips).
...
This patch converts `Ms. Pac-Man - Special Color Edition (U)` to the `.pocket` format.
...
This patch converts `NBA Jam - Tournament Edition (U)` to the `.pocket` format.
...
This patch converts `Nemesis (U)` to the `.pocket` format.
...
This patch converts `Ninja Boy (U,E)` to the `.pocket` format.
...
This patch converts `Nintendo World Cup (U,E)` to the `.pocket` format.
...
This patch converts `Oddworld Adventures (U,E)` to the `.pocket` format.
...
This patch converts `Pac-Panic (J)` to the `.pocket` format.

ROM MD5: `f683f5e516c1f267d4d16dc0e697f746`
...
This patch converts `Paperboy 2 (U,E)` to the `.pocket` format.
...
This patch converts `Pinball Fantasies (U,E)` to the `.pocket` format.
...
This patch converts `Pitfall - Beyond the Jungle (U,E)` to the `.pocket` format.
...
This patch converts `Pokemon Pinball (J)` to the `.pocket` format.

ROM MD5: `852d68f167a5957f5e73954763f36ada`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/PokemonPinballJ.ips).
...
This patch was updated to fix possible save corruption. (2022/06/06)
...
## Pokemon Playable Yellow

This patch converts `Pokemon Playable Yellow` to the `.pocket` format. First, apply the [Playable Yellow patch](https://www.romhacking.net/hacks/4264/), resulting in the MD5 below, then apply this patch.
...
This patch converts `Probotector (E)` to the `.pocket` format.
...
This patch was updated to fix a lock up issue after the first level. (2022/03/30)

This patch was updated to fix a lock up issue at the end. (2022/03/30)
...
This patch converts `Ranma 1/2 (J)` to the `.pocket` format.
...
This patch converts `Ren and Stimpy Show - The Veediots! (U,E)` to the `.pocket` format.
...
This patch converts `Ring Rage (U)` to the `.pocket` format.

ROM MD5: `6c4d2f2a4aa7029759441d2c16d8c931`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/RingRage.ips).
...
This patch converts `Robin Hood - Prince of Theives (U)` to the `.pocket` format.

ROM MD5: `2815ff13131712bcd00c3852d461b414`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/RobinHood.ips).
...
This patch converts `Rockman World 2 (J)` to the `.pocket` format.

ROM MD5: `c05b47df8bdfe770be228e51bc42da84`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/RockmanWorld2.ips).

## Rockman World 3

This patch converts `Rockman World 3 (J)` to the `.pocket` format.
...
This patch converts `Rockman World 5 (J)` to the `.pocket` format.

ROM MD5: `309fc69d5ab1d2b17d0bbc127faf04c1`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/RockmanWorld5.ips).

## Rodland

This patch converts `Rodland (E)` to the `.pocket` format.
...
This patch converts `Roswell Conspiracies - Aliens, Myths and Legends (U)` to the `.pocket` format.
...
## Roswell Conspiracies - Aliens, Myths and Legends (E)

This patch converts `Roswell Conspiracies - Aliens, Myths and Legends (E)` to the `.pocket` format.
...
This patch converts `Sabrina - The Animated Series - Spooked! (U,E)` to the `.pocket` format.
...
This patch converts `Shanghai (U)` to the `.pocket` format.
...
This patch converts `Shanghai Pocket (Rev A) (U,E)` to the `.pocket` format.

ROM MD5: `f7e13de010decf104efa3db865971f34`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/ShanghaiPocketA.ips).

## Shanghai Pocket (J)

This patch converts `Shanghai Pocket (J)` to the `.pocket` format.

ROM MD5: `c042681adbbe175b354d0abee3413219`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/ShanghaiPocketJ.ips).

## Shantae (Limited Run Games)

This patch converts `Shantae (Limited Run Games)` to the `.pocket` format.
...
This patch converts `Shin Pokemon Blue v1.23` to the `.pocket` format. It is a `.pocket` conversion for the output from the [Shin Pokemon project](https://github.com/jojobear13/shinpokered). The MD5 was generated by applying the [Shin Pokemon Blue patch](https://github.com/jojobear13/shinpokered/raw/master/ips_patches/shin_pokemon_blue_v1.23.ips) to the `Pokemon Blue (U,E)` ROM. The resulting MD5 is shown below.

ROM MD5: `435196c4a4c0fa6f0d4cefdc3cb46060`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/ShinPokemonBluev1.23.ips).

## Shin Pokemon Blue (J)

This patch converts `Shin Pokemon Blue (J) v1.23` to the `.pocket` format. It is a `.pocket` conversion for the output from the [Shin Pokemon project](https://github.com/jojobear13/shinpokered). The MD5 was generated by applying the [Shin Pokemon Blue Japan patch](https://github.com/jojobear13/shinpokered/raw/master/ips_patches/shin_pokemon_bluejp_v1.23.ips) to the `Pokemon Blue (U,E)` ROM. The resulting MD5 is shown below.

ROM MD5: `13bad3a2c036aea35053d977eb6240db`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/ShinPokemonBlueJv1.23.ips).

## Shin Pokemon Green

This patch converts `Shin Pokemon Green v1.23` to the `.pocket` format. It is a `.pocket` conversion for the output from the [Shin Pokemon project](https://github.com/jojobear13/shinpokered). The MD5 was generated by applying the [Shin Pokemon Green patch](https://github.com/jojobear13/shinpokered/raw/master/ips_patches/shin_pokemon_green_v1.23.ips) to the `Pokemon Red (U,E)` ROM. The resulting MD5 is shown below.

ROM MD5: `1669f161c868bde90c0c82fdce31fb04`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/ShinPokemonGreenv1.23.ips).

## Shin Pokemon Red

This patch converts `Shin Pokemon Red v1.23` to the `.pocket` format. It is a `.pocket` conversion for the output from the [Shin Pokemon project](https://github.com/jojobear13/shinpokered). The MD5 was generated by applying the [Shin Pokemon Red patch](https://github.com/jojobear13/shinpokered/raw/master/ips_patches/shin_pokemon_red_v1.23.ips) to the `Pokemon Red (U,E)` ROM. The resulting MD5 is shown below.

ROM MD5: `15cf46c8487707fe201c9ff91a21f51e`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/ShinPokemonRedv1.23.ips).

## Shin Pokemon Red (J)

This patch converts `Shin Pokemon Red (J) v1.23` to the `.pocket` format. It is a `.pocket` conversion for the output from the [Shin Pokemon project](https://github.com/jojobear13/shinpokered). The MD5 was generated by applying the [Shin Pokemon Red Japan patch](https://github.com/jojobear13/shinpokered/raw/master/ips_patches/shin_pokemon_redjp_v1.23.ips) to the `Pokemon Red (U,E)` ROM. The resulting MD5 is shown below.

ROM MD5: `846fd740c115c66a379ff38b59f9cc3d`
...
This patch converts `Snail DX` to the `.pocket` format. You can get a copy of the ROM from the [developer's site](https://gearupgames.itch.io/the-snail-dx).

ROM MD5: `1b8671a31a0c30a62eef62ddb4bf915f`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/SnailDX.ips).
...
## Snowboard Champion (English Translation v1.01)

This patch converts `Snowboard Champion (English Translation v1.01)` to the `.pocket` format. First, apply the [English Translation patch](https://www.romhacking.net/translations/6975/), which results in the MD5 below, then apply this patch.

ROM MD5: `24af8c3ec86e70cd098c8e7fcdeb54bd`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/SnowboardChampion_EN_1.01.ips).
...
This patch converts `Space Invaders (E)` to the `.pocket` format.

ROM MD5: `704cefb5c77dc74631b9acbaa2b19435`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/SpaceInvadersE.ips).

## Space Invaders (J)

This patch converts `Space Invaders (J)` to the `.pocket` format.
...
This patch converts `Space Station Silicon Valley (E)` to the `.pocket` format.
...
This patch converts `Spirou Robbedoes - The Robot Invasion (E)` to the `.pocket` format.

ROM MD5: `144fc4636fcefbd56d906505f5308da1`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/SpirouRobbedoes.ips).
...
This patch converts `Stargate (U,E)` to the `.pocket` format.
...
This patch converts `Star Ocean - Blue Sphere (English Translation)` to the `.pocket` format. First, apply the [English Translation patch](https://archive.org/download/staroceanenglish), then apply the [Bug Fix patch](https://www.romhacking.net/translations/6498/), which results in the MD5 below, then apply this patch.

ROM MD5: `70bcee3fd3813fe23646e0c79fd0e0f5`
...
This patch converts `Super Mario Land (W)` to the `.pocket` format.

ROM MD5: `b48161623f12f86fec88320166a21fce`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/SuperMarioLand.ips).
...
This patch converts `SWIV (E)` to the `.pocket` format.

ROM MD5: `3a00468ea1520a57f23f88d43cf8c067`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/SWIV.ips).
...
This patch converts `Tasmania Monogatari (J)` to the `.pocket` format.

ROM MD5: `d413f826b00d3f2384555490d0f1271d`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/TasmaniaMonogatari.ips).

## Tasmania Story

This patch converts `Tasmania Story (U)` to the `.pocket` format.

ROM MD5: `46972f66b5c73b6b19fe21077b195669`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/TasmaniaStory.ips).
...
This patch converts `Taz-Mania 2 (U)` to the `.pocket` format.

ROM MD5: `985bf1d3fdf54038dbde36fd372fbe2c`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/TazMania2.ips).
...
This patch converts `Teke! Teke! Asmik-kun World (J)` to the `.pocket` format.

ROM MD5: `563c4c81878db48d8a0b6091f4c1cd92`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/TekeTekeAsmik.ips).

## Telefang - Power Edition (NoRTC)

This patch converts `Keitai Denjuu Telefang: Power Version` to `Telefang - Power Edition (NoRTC)` in the `.pocket` format. It is a patched version of [the English Translation](https://github.com/telefang/telefang/tree/patch) project, version 151. This patches the original Japanese ROM with the MD5 below.
...
This patch converts `Keitai Denjuu Telefang: Speed Version` to `Telefang - Speed Edition (NoRTC)` in the `.pocket` format. It is a patched version of [the English Translation](https://github.com/telefang/telefang/tree/patch) project, version 151. This patches the original Japanese ROM with the MD5 below.
...
This patch converts `Tintin - Prisoners of the Sun (E)` to the `.pocket` format.

ROM MD5: `46ed332d95c5da9a2007945fed9f8118`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/Tintin-PotS.ips).
...
ROM MD5: `3f45aaeb406c50d03fc6984908fcbfa5`
...
ROM MD5: `3b2f918967698c3eef1f04ef7cd5601a`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/TitusFoxGBCE.ips).
...
This patch converts [Tobu Tobu Girl DX](https://tangramgames.dk/tobutobugirldx/) to the `.pocket` format.

ROM MD5: `c48f26f5079ad1b411c78fbcb2738d67`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/TobuDX.ips).
...
This patch converts `Tokimeki Memorial Pocket - Sport Hen - Koutei no Photograph (J)` to the `.pocket` format.
...
This patch converts `Tom Clancy's Rainbow Six (U,E)` to the `.pocket` format.
...
This patch converts `Turok - Battle of the Bionosaurs (U,E)` to the `.pocket` format.
...
## Turok - Battle of the Bionosaurs (J)

This patch converts `Turok - Battle of the Bionosaurs (J)` to the `.pocket` format.

ROM MD5: `412075e19f160df8c3571ae37184d827`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/TurokBattleBionosaursJ.ips). 
...
This patch converts `Tyco RC - Racin' Ratz (U)` to the `.pocket` format.

ROM MD5: `9dece7202bd00a2806b36b5848ca985e`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/TycoRCRacinRatz.ips).

## uCity

This patch converts `uCity (v1.2)` to the `.pocket` format. You can get a copy of the game from the [developer's github](https://github.com/AntonioND/ucity).

ROM MD5: `a13bebff10a53c113554b8e882343d9d`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/uCity.ips).
...
This patch converts `Uno (U)` to the `.pocket` format.
...
This patch converts `V-Rally - Championship Edition (U)` to the `.pocket` format.
...
This patch converts `Wario Land - Super Mario Land 3 DX` to the `.pocket` format. This patch is applied after the [colorization patch](https://www.romhacking.net/hacks/6683/) has been applied to the original ROM, the MD5 below is for the patched ROM.
...
## Wario Land - Super Mario Land 3 DX (v1.1)
...
This patch converts `WWF - War Zone (U,E)` to the `.pocket` format.

ROM MD5: `4f99d49908e027125473445ea1937817`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/WWFWarZone.ips).
...
This patch converts `Yoshi no Tomago (J)` to the `.pocket` format.

ROM MD5: `0ccb1e6beb86d79a7a5dad81eb6c73a9`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/YoshiNoTamago.ips).
...
This patch converts `Yu-Gi-Oh! Duel Monsters (J)` to the `.pocket` format.

ROM MD5: `770a917f18e0aa1f3bb027d0783f548b`

You can [download the Analogue Pocket IPS patch here](https://github.com/JoseJX/analogue-pocket-patches/raw/main/YuGiOh-DuelMonstersJ.ips).
...
For a complete tutorial, please take a look at TreyTurner's excellent [patching tutorial](https://github.com/treyturner/analogue-pocket-patches/blob/main/TUTORIAL.md). For the short version, keep reading!
